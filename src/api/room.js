 ...
 * @Last Modified time: 2020-08-21 11:06:53
 */

import { getAction } from '@/utils/ajax'

const getRoomCascader = () => getAction('/common', { CMD: 'get_building_floor_room' })
const getRoomDeviceList  = (device) => getAction('/common', { CMD: 'get_room_device', device: JSON.stringify(device) })
